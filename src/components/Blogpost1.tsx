        ...
        <div className="container">
          ...
          <div className="row">
            ...
            <div className="col-lg-8">
              ...
              <hr />
              {/* Date/Time */}
              <p>โพสต์เมื่อวันที่ 18 ธันวาคม 2567 โดยปนัดดา ดอนเกษม</p>
              <hr />
              {/* Post Content */}
              <p className="lead">แนวคิดปรัชญากับการพัฒนาองค์การ</p>
              <p>
                แนวคิดปรัชญากับการพัฒนาองค์การ ได้แก่{" "}
                <ol className="ml-4" style={{ listStyleType: "upper-alpha" }}>
                  <li>
              ...
              <p>
                ...
                <ul className="ml-4" style={{ listStyleType: "upper-roman" }}>
                  ...
                  <li>
                    ...
                    Science) บริหารโดยผู้บริหารระดับสูง
                  </li>
                  <li>
                ...
                <ul className="ml-4" style={{ listStyleType: "decimal" }}>
                  ...
                  <ul className="ml-4" style={{ listStyleType: "square" }}>
                    <li>
                      ...
                      (One Best Way)
                      ในการบริหารองค์การรูปแบบการจัดการแบบมีส่วนร่วม
                  ...
                  <ul className="ml-4" style={{ listStyleType: "decimal" }}>
                    ...
                    <ul className="ml-4" style={{ listStyleType: "decimal" }}>
                      ...
                      <li>
                        ...
                        -การสัมภาษณ์ -การสำรวจความคิดเห็นด้วยแบบสอบถาม
                    ...
                    <ul className="ml-4" style={{ listStyleType: "disc" }}>
                      ...
                      <li>
                        ...
                        Resources)ระยะเวลาดำเนินโครงการ ค่าใช้จ่ายที่เกี่ยวข้อง
                      </li>
                      <li>
              ...
              <p>
                ...
                <ul className="ml-4" style={{ listStyleType: "decimal" }}>
                  ...
                  <li>
                    ที่ปรึกษาภายใน
                    ได้แก่บุคลากรขององค์การทั้งที่ที่ปฏิบัติงานด้าน OD
                    โดยเฉพาะหรือที่ปฏิบัติงานด้านอื่นร่วม เช่น งานด้านฝึกอบรม
